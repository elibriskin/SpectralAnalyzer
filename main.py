...
class FSRMenu(QDialog):
    def __init__(self, parent=None):
        ...
        self.layout.addRow("Peak 1 Start (lambda): ", self.peak1_start)
        self.layout.addRow("Peak 1 End (lambda): ", self.peak1_end)
        self.layout.addRow("Peak 2 Start (lambda): ", self.peak2_start)
        self.layout.addRow("Peak 2 End (lambda): ", self.peak2_end)
        self.layout.addWidget(self.buttonBox)
        self.setLayout(self.layout)
